---
title: Sending received trading data into zmq.
layout: post
category: live
language: en
---

This script demonstrates how to receive market data, including tick and bar data from a strategy and send out
those received trading data into zmq queue. It demonstrates how the zmq sending is done in separate threads.
