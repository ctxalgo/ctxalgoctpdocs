# -*- coding: utf-8 -*-
#
# Halo documentation build configuration file, created by
# sphinx-quickstart on Wed Sep  9 21:46:16 2015.
#
...
sys.path.insert(0, os.path.abspath('/var/lib/jenkins/workspace'))
...
html_theme = 'sphinx_rtd_theme_collapse'
